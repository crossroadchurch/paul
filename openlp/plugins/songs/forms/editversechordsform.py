...
from .editversechordsdialog import Ui_EditVerseChordsDialog
...
class EditVerseChordsForm(QtGui.QDialog, Ui_EditVerseChordsDialog):
    """
    ...
    def __init__(self, parent=None):
        ...
        Constructor
        """
        super(EditVerseChordsForm, self).__init__(parent)
        self.setupUi(self)
